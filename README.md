# Tiny React Apps (Copy of shared repo)     
[Original Repo](https://github.com/samelawton/fe-tiny-react-apps)

This was a pair programming excercise and an early intro to React.  
Pretty good fun, any similarities to existing software is purely coincidental (and in jest).  

The excercise criteria I've left intact below.  
